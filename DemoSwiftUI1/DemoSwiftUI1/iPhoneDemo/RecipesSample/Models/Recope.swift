...
//        (now..<later).formatted(.components(style: .condensedAbbreviated))
...
//        aTemp.formatted()
    ...
    var thumbnailImage: Image {
        let aName = imageNames.last ?? "placeholder"
        return ImageStore.shared.image(name: aName)
    }
    ...
    var collectionsAsText: String {
        ...
        set {
            collections = newValue.replacingOccurrences(of: ", ", with: ",").components(separatedBy: ",")
        }
    }
